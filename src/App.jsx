...
export default function App() {
  ...
  // Mağaza Başlangıçta Boş (0'dan eklenecek)
  ...
  useEffect(() => {
    ...
    // Mağaza ürünlerini çeken listener
  ...
  function renderTrialPromptModal() {
  ...
  function renderPremiumWarningModal() {
  ...
  function renderPaymentCodeModal() {
